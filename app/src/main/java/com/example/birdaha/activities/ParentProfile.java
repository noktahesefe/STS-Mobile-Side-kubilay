...
public class ParentProfile extends AppCompatActivity {
    ...
    public void checkPermissionAndOpenGallery(String permission, int requestCode){
        if(!isGranted){
            ActivityCompat.requestPermissions(ParentProfile.this, new String[] {permission}, requestCode);
        }
        else{
            openGallery();
        }
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setNegativeButton("Reddet", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(ParentProfile.this, "İzin verilmedi. Galeriye erişilemiyor!", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
            }
